...
import com.in28minutes.microservices.currencyconversionservice.entity.CurrencyExchange;
...
public class CurrencyConversionController {
    ...
    public CurrencyConversion calculateCurrencyConversionFeign(
        ...
        CurrencyExchange currencyExchange = currencyExchangeProxy.retrieveExchangeValue(from, to);
        return new CurrencyConversion(currencyExchange.getId(), from, to, quantity,
                currencyExchange.getConversionMultiple(),
                quantity.multiply(currencyExchange.getConversionMultiple()),
                currencyExchange.getEnvironment());
